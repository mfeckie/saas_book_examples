...
ActiveRecord::Schema.define(:version => 20130320195352) do
  ...
  create_table "subscribem_accounts_users", :id => false, :force => true do |t|
    t.integer "account_id"
    t.integer "user_id"
  end

  add_index "subscribem_accounts_users", ["account_id"], :name => "index_subscribem_accounts_users_on_account_id"
